...
public class Blog {
    ...
    private BlogExtra blogExtra;//额外信息
    ...
    public void emojiConvert(){
        try{
            this.html=emojiConvertToUtf(this.html);
        }catch (Exception ex){
            //不处理
        }
        try{
            this.text=emojiConvertToUtf(this.text);
        }catch (Exception ex){
            //不处理
        }
    }
    ...
    public void convertEmoji(){
        try{
            this.html=utfemojiRecovery(this.html);
        }catch (Exception ex){
            //不处理
        }
        try{
            this.text=utfemojiRecovery(this.text);
        }catch (Exception ex){
            //不处理
        }
    }
