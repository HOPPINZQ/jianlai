...
(function ($) {
    ...
    ATBS.header = {
        init: function () {
            ...
            init: function init(options) {
                ...
                } else if (!this.$fixedHeader.length || !this.$headerPlaceHolder.length || (ATBS.documentOnResize.windowWidth <= ATBS.header.smartAffix.breakpoint)) {
    ...
    ATBS.documentOnScroll = {
        ticking: false, windowScrollTop: 0, init: function () {
    ...
    ATBS.documentOnResize = {
        ticking: false, windowWidth: $window.width(), init: function () {
        ...
        init: function () {
            ...
            $carousels.each(function () {
                $(this).owlCarousel({
                    ...
                    smartSpeed: 500,
                    responsive: {
                        0: {items: 1, dots: true, nav: false, margin: 40,},
                        576: {items: 1, margin: 50,},
                        768: {margin: 60,},
                        992: {margin: 60,}
                    },
                });
            ...
            $carousels.each(function () {
                ...
                $(this).owlCarousel({
                    ...
                    smartSpeed: 500,
                    onInitialized: owl_onInitialized,
                    responsive: {1200: {margin: 85,}, 1680: {margin: carousel_margin,}}
                });
            ...
            $carousels.each(function () {
                ...
                $(this).owlCarousel({
                    ...
                    responsive: {
                        0: {margin: 30,},
                        576: {margin: 30, mouseDrag: false, touchDrag: false,},
                        768: {margin: 40, mouseDrag: false, touchDrag: false,},
                        992: {margin: 60, mouseDrag: false, touchDrag: false,},
                        1200: {margin: carousel_margin, mouseDrag: false, touchDrag: false,}
                    },
                });
            ...
            $carousels.each(function () {
                ...
                $(this).owlCarousel({
                    ...
                    navText: ['<i class="mdicon mdicon-navigate_before"></i>', '<i class="mdicon mdicon-navigate_next"></i>'],
                    smartSpeed: 800,
                    responsive: {0: {margin: 15,}, 481: {margin: carousel_margin,}},
                });
            })
            ...
            $carousels.each(function () {
                ...
                $(this).owlCarousel({
                    ...
                    navText: ['<i class="mdicon mdicon-navigate_before"></i>', '<i class="mdicon mdicon-navigate_next"></i>'],
                    smartSpeed: 800,
                    responsive: {0: {margin: 15,}, 481: {margin: 30,}, 992: {margin: carousel_margin,},},
                });
            })
            ...
            $carousels.each(function () {
                ...
                $(this).owlCarousel({
                    ...
                    onInitialized: owl_onInitialized,
                    responsive: {
                        0: {margin: 30, autoWidth: false, items: 1, nav: false, dots: true,},
                        481: {margin: 30,},
                        992: {margin: carousel_margin,},
                    },
                });
            ...
            $carousels.each(function () {
                ...
                $(this).owlCarousel({
                    ...
                    responsive: {0: {items: 1, margin: 30,}, 576: {items: 2,}, 992: {items: 1,},},
                });
            ...
            $(function () {
                ...
                function resetHorizontalScroll($el) {
                    ...
                    if ($el.data('transformX') <= $el.data('rightMax')) {
                        $el.data('contentWrapper').css({'transform': 'translate3d(' + $el.data('rightMax') + 'px, 0, 0)',});
                    }
                }
                ...
                function transformBasedOnScrollHorizontalScroll($el) {
                    ...
                    if ($el.data('initalized') == true) {
                        $el.data('contentWrapper').css({'transform': 'translate3d(' + $el.data('transformX') + 'px, 0, 0)'});
                    }
                }
            ...
            setTimeout(function () {
                ...
                if ($.isFunction($.fn.theiaStickySidebar)) {
                    $stickySidebar.theiaStickySidebar({additionalMarginTop: marginTop, additionalMarginBottom: 20,});
                }
            }, 250);
    ...
    ATBS.documentOnLoad = {
        init: function () {
            ATBS.header.smartAffix.compute();
            ATBS.header.smartAffix.updateState();
