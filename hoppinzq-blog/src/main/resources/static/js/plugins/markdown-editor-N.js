...
! function ($) {
    ...
    Markdown.prototype = {
        ...
        buildMarkdown: function (commands) {
            $that = this;
            var L = ['<div class="btn-toolbar markdown-toolbar" style="font-size: 0;border-bottom: 1px solid #EEE"><div class="btn-group btn-group-sm">'];
    ...
    $.fn.markdown.defaults = {
        buttons: [
            'heading',
            '|',
            'bold', 'italic', 'ul', 'quote','link','image',
            '|',
            'preview',
            '|',
            'fullscreen',
        ...
        icons: {
            'heading': 'w-e-icon-header',
            'bold': 'w-e-icon-bold',
            'italic': 'w-e-icon-italic',
            'ul': 'w-e-icon-list2',
            'quote': 'w-e-icon-quotes-left',
            'link': 'w-e-icon-link',
            'image': 'w-e-icon-image',
            'preview': 'icon ion-eye',
            'fullscreen': 'w-e-icon-fullscreen',
        },
        upload_image_url: '',
        upload_file_url: '',
    };
