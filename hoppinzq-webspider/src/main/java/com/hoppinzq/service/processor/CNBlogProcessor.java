...
public class CNBlogProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        String blogText=page.getHtml().xpath("//*[@id=\"author_profile_detail\"]/a[1]/text()").toString();
        ...
        String like=page.getHtml().xpath("//*[@id=\"digg_count\"]/text()").toString();
        String collect=page.getHtml().xpath("//*[@id=\"digg_count\"]/text()").toString();
        //
