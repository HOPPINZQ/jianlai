...
public class GetWeb {
	...
	public static List<String> getImagePathList(String httpUrl)
		...
		// 通过img标签匹配网页图片的正则表达式
		String searchImgReg = "<(img|IMG|video|VIDEO|source|SOURCE)\\b[^>]*\\b(src|SRC|src2|SRC2)\\b\\s*=\\s*('|\")?([^'\"\n\r\f>]+(\\.jpg|\\.bmp|\\.eps|\\.gif|\\.mif|\\.miff|\\.png|\\.tif|\\.tiff|\\.svg|\\.wmf|\\.jpe|\\.jpeg|\\.dib|\\.ico|\\.tga|\\.cut|\\.pic|\\.mp4|\\.mp3)\\b)[^>]*>";
